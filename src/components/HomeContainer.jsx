...
import heroData from "../untils/data";
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        <div>
          ...
          <p className="text-base my-6 text-textColor text-center md:text-left md:w-[80%]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
            finibus, mauris lobortis euismod molestie, ante elit efficitur est,
            vulputate egestas libero dui sit amet eros. Ut iaculis tellus et
            sapien vulputate, vitae vulputate nulla malesuada
          </p>
      ...
      <div className="py-2 p-4 flex-1 flex items-center relative">
        <img
          src={HeroBg}
          ...
          {heroData &&
            heroData.map((n) => (
              ...
              >
                ...
                <p className="text-[12px] lg:text-sm font-semibold text-lightttextGray my-1 lg:my-3">
                  {n.decp}
                </p>
